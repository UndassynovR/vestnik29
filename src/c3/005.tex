...
{\bfseries STUDY OF PHYSICOCHEMICAL PROPERTIES OF ADSORBENTS OBTAINED BASED
ON TEXTILE CORD}

{\bfseries \tsp{1}M.K.
Kazankapova}\fig{c3/image1}{}{\bfseries \envelope ,
\tsp{1}B.T.
Yermagambet}\fig{c3/image1}{}{\bfseries ,
\tsp{1,2}U.M.Kozhamuratova}\fig{c3/image1}{}{\bfseries ,
\tsp{2}Zh.E.Jakupova}\fig{c3/image1}{}\envelope 

\emph{\tsp{1}«Institute of Coal Chemistry and Technology»
LLP, Astana, Kazakhstan,}

\emph{\tsp{2}«L.N. Gumilyov Eurasian National University,
Astana, Kazakhstan}
...
porous adsorbents, nanomaterials, carbonization.

{\bfseries ТОҚЫМА СЫМЫ НЕГІЗІНДЕ АЛЫНҒАН АДСОРБЕНТТЕРДІҢ ФИЗИКА-ХИМИЯЛЫҚ
ҚАСИЕТТЕРІН ЗЕРТТЕУ}

{\bfseries \tsp{1}М.Қ.Қазанқапова\envelope ,
\tsp{1}Б.Т.Ермағамбет,
...
физика-химиялық принциптері мен принциптері қарастырылады. Пайдаланылған
автомобиль шиналарының жинақталуы және оларды қайталама өнім ретінде
...
{\bfseries ИЗУЧЕНИЕ ФИЗИКО-ХИМИЧЕСКИХ СВОЙСТВ АДСОРБЕНТОВ, ПОЛУЧЕННЫХ НА
ОСНОВЕ ТЕКСТИЛЬНОГО КОРДА}

{\bfseries \tsp{1}М.К. Казанкапова\envelope ,
\tsp{1}Б.Т. Ермагамбет, \tsp{1,2}У.М.
Кожамуратова, \tsp{2}Ж.Е.Джакупова\envelope }

\emph{\tsp{1}ТОО «Институт химии угля и технологии», Астана,
Казахстан,}

\emph{\tsp{2} «Евразийский национальный университет имени
...
{\bfseries Fig.1 - Schematic diagram of a laboratory setup for steam-gas
activation:}

\emph{1 - gas cylinder (nitrogen), 2 - steam generator, 3 -- reactor, 4
-- LATR, 5 - temperature sensor, 6 - direct condenser,}

\emph{7 - flask for cleaning gas from resins, 8 - gas outlet}
...
2H\tsb{2}O → 2H\tsb{2} + O\tsb{2} --
115700 kcal (1)

C + H\tsb{2}O → CO + H\tsb{2} -- 28150 kcal (2)

\begin{quote}
C + CO\tsb{2} → 2CO -- 38400 kcal (3)
\end{quote}

C + 2H\tsb{2} → CH\tsb{4} + 18600 kcal (4)
...
{\bfseries Table 1 -- Gas composition of carbonization and activation of
textile cord}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.1142}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0820}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0911}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0911}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0759}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0911}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0909}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0911}}@{}}
...
%% Т\tsb{1} С°
%% \end{minipage}} &
%% \multicolumn{9}{>{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.8039} + 16\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Gas composition (volume, \%)}
%% \end{minipage}} \\
%% & & \begin{minipage}[b]{\linewidth}\centering
%% О\tsb{2}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% \multirow{5}{=}{\centering\arraybackslash Carbonization} & 200 & 37.003
%% & 0.046 & 0.126 & 32.911 & 0.166 & 0.040 & 0.005 & - & 0.589 \\
...
%% 1.012 \\
%% & 600 & 34.526 & 3.091 & 1.671 & 61.023 & 2.570 & - & 0.918 & 0.565 &
%% 1.012 \\
%% \multirow{3}{=}{\centering\arraybackslash Activation} & 700 & 30.469 &
%% 3.873 & 0.411 & 76.123 & 0.746 & - & 0.137 & 0.036 & 0.162 \\
%% & 800 & 28.204 & 5.608 & 0.302 & 75.943 & 0.813 & 0.436 & 0.066 & 0.080
%% & 0.082 \\
%% & 900 & 27.532 & 3.304 & 0.157 & 79.477 & 0.841 & 0.511 & 0.038 & 0.058
%% & 0.006 \\
%% \end{longtable}
...
{\bfseries Table 2 - Material Balance of Textile Cord after activation}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% \multirow{3}{=}{\centering\arraybackslash Initial Material} & Textile
%% cord & 200.00 & 66.67 \\
%% & Water & 100.00 & 33.33 \\
%% & Total & 300.00 & 100.00 \\
%% \multirow{4}{=}{\centering\arraybackslash Product} & Solid Residue
%% (adsorbent) & 68.40 & 22.80 \\
%% & Gas & 201.66 & 67.22 \\
...
{\bfseries Fig.2 - Chromatogram of liquid products from carbonization and
activation of nylon cord}
...
{\bfseries Table 3 - Elemental composition obtained using a portable X-ray
fluorescence instrument}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1830}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2149}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1995}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1994}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2033}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\centering\arraybackslash \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Elemental composition}
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4143} + 2\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Initial textile cord}
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.4026} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Activated textile cord}
%% \end{minipage}} \\
%% & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries \%}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4990}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5010}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% \fig{c3/image33}{}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Fig.3 - SEM results of the Initial Textile Cord: а-х500;
b-х5000}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4964}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5036}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% \fig{c3/image35}{}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Fig.4 - SEM results of the Activated Textile Cord: а-х500;
b-х5000}
...
Қожамұратова Ұ.М. - магистрант, Евразийский национальний университет им.
...
L.N. Gumilyov, Astana, Kazakhstan, e-mail:
kozhamuratova.u@mail.ru;
