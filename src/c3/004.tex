...
\texorpdfstring{{\bfseries ВЛИЯНИЕ АМОРФНОГО КРЕМНИЯ НА ФИЗИЧЕСКОЕ
И ХИМИЧЕСКОЕ СОСТОЯНИЕ ПОЧВЫ}
}{ВЛИЯНИЕ АМОРФНОГО КРЕМНИЯ НА ФИЗИЧЕСКОЕ И ХИМИЧЕСКОЕ СОСТОЯНИЕ ПОЧВЫ }

\texorpdfstring{{\bfseries \tsp{1}М.Ш.Сулейменова}\protect\fig{c3/image1}{}
, {\bfseries \tsp{1}С.Т.
Дәуметова}\protect\fig{c3/image1}{}{\bfseries \envelope ,
\tsp{2}E.Varol}\protect\fig{c3/image1}{},
{\bfseries \tsp{1}Г.О.Бугубаева}\protect\fig{c3/image1}{},{\bfseries \tsp{1}М.С.
Жетенова}\protect\fig{c3/image1}{}}{1М.Ш.СулейменоваD:\textbackslash Desktop\textbackslash иконка.png , 1С.Т. ДәуметоваD:\textbackslash Desktop\textbackslash иконка.png\envelope , 2E.VarolD:\textbackslash Desktop\textbackslash иконка.png, 1Г.О.БугубаеваD:\textbackslash Desktop\textbackslash иконка.png,1М.С. ЖетеноваD:\textbackslash Desktop\textbackslash иконка.png}

\texorpdfstring{\tsp{1}\emph{Алматинский
технологический университет, Алматы,
Казахстан,}}{1Алматинский технологический университет, Алматы, Казахстан,}

\tsp{2}\emph{Эскишехирский технический университет,
Эскишехир, Турция}

\texorpdfstring{\envelope Корреспондент-автор:
daumetova83@mail.ru}{\envelope Корреспондент-автор: daumetova83@mail.ru}
...
\texorpdfstring{{\bfseries EFFECT OF AMORPHOUS SILICON ON THE
PHYSICAL AND CHEMICAL STATE OF
SOIL}}{EFFECT OF AMORPHOUS SILICON ON THE PHYSICAL AND CHEMICAL STATE OF SOIL}

{\bfseries \tsp{1}M.Suleimenova,
\tsp{1}S.Daumetova\envelope ,
\tsp{2}E.Varol, \tsp{1}G.Bugubaeva,
\tsp{1}М.Zhetenova}

\emph{Almaty Technological University, Almaty, Kazakhstan,}

\emph{Eskisehir Technical University, Eskisehir, Turkey,}

\texorpdfstring{e-mail:daumetova83@mail.ru}{e-mail:daumetova83@mail.ru}
...
source of water for plants, and optimal density - good aeration and root
penetration.
...
\texorpdfstring{{\bfseries АМОРФТЫ КРЕМНИЙДІҢ ТОПЫРАҚТЫҢ ФИЗИКАЛЫҚ
ЖӘНЕ ХИМИЯЛЫҚ КҮЙІНЕ
ӘСЕРІ}}{АМОРФТЫ КРЕМНИЙДІҢ ТОПЫРАҚТЫҢ ФИЗИКАЛЫҚ ЖӘНЕ ХИМИЯЛЫҚ КҮЙІНЕ ӘСЕРІ}

\texorpdfstring{{\bfseries \tsp{1}М.Ш.Сулейменова,
\tsp{1}С.Т. Дәуметова\envelope ,
\tsp{2}E.Varol, \tsp{1}Г. Бугубаева,}
{\bfseries \tsp{1}М.С.
Жетенова}}{1М.Ш.Сулейменова, 1С.Т. Дәуметова\envelope , 2E.Varol, 1Г. Бугубаева, 1М.С. Жетенова}

\texorpdfstring{\emph{Алматы технологиялық университеті,
Алматы,
Қазахстан,}}{Алматы технологиялық университеті, Алматы, Қазахстан,}

\emph{Ескішехир техникалық университеті, Ескішехир, Түркия,}
...
{\bfseries Рис.1 - Распределение элементов в земной коре}
...
{\bfseries Таблица 1 - Содержание кремния в некоторых растениях.}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2876}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2121}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2730}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2274}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Растение}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Si по сухому весу \%}
...
%% Helianthus annuus, hulls & 1,23--2,27 & Gossypium barbadence &
%% 0,28--0,71 \\
...
%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0246}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9754}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% \fig{c3/image26}{}
...
{\bfseries Таблица 2 - Свойства аморфного диоксида кремния из рисовой
шелухи.}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1392}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0980}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0856}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0912}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0969}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1101}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0910}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1213}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1667}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Материал}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% аморфный диоксид кремния (рисовая шелуха) & 6,2-8,5 & 0 & 0,31 & 0,57 &
%% 0 & 0,23 & 93,1 & 90 \\
%% \end{longtable}
...
{\bfseries Рис.3 - Цвета сгоревшей рисовой шелухи при разных температурах}

\fig{c3/image28}{}

Температура, °С

{\bfseries Рис.4 - Масса золы рисовой шелухи после термообработки, м/г}
...
NaOH + SiO\tsb{2} → Na\tsb{2}SiO\tsb{3}
+H\tsb{2} (1)
...
Na\tsb{2}SiO\tsb{3} + 2HCl
→H\tsb{2}SiO\tsb{3}↓+2NaCl (2)

H\tsb{2}SiO\tsb{3} (кремниевая кислота) →
SiO\tsb{2} + H\tsb{2}O (3)
...
{\bfseries Рис.5 - Процент влажности почвы без удобрений}
...
{\bfseries Рис.6 - Процент влажности почвы после внесения биопрепарата
кремния}
...
{\bfseries Таблица 3 - Оценка плотности грунта}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2400}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2730}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2401}}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% <1,0 & Почва рыхлая или богатая органическими веществами. & 1,3
%% -- 1,4 & Почва очень уплотненная \\
%% 1,0 -- 1,1 & Свежевспаханная почва & 1,4 - 1,6 & Типичные значения
%% орошаемых горизонтов (кроме чернозема) \\
%% \end{longtable}
...
Эскишехир, Турция, e-mail:
eapaydin@eskisehir.edu.tr;
