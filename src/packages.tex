...
\usepackage{xparse} % for flexible command arguments

\makeatletter
\newif\ifinfigs
\infigsfalse

% figs environment for side-by-side images
\newenvironment{figs}{%
  \infigstrue
  \par\noindent\centering\ignorespaces
}{%
  \par\infigsfalse\ignorespacesafterend
}
...
% {path} - required, image path (media/ prefix added automatically)
