\id{МРНТИ 61.45.36; 27.35.30}{}

\begin{header}
\swa{}{МАТЕМАТИЧЕСКАЯ МОДЕЛЬ ЭКСТРАКЦИИ НА ОСНОВЕ КИНЕТИКИ ЭКСТРАКЦИОННОГО ПРОЦЕССА}

\tsp{1,2}К.М. Сулейменов,
\tsp{3}Г.Қ. Мамытбекова,
\tsp{3}Ж. Нұрымов,
\tsp{3,4}К.Г. Сатенов,
\tsp{3,4,5}Е.М.Сүлеймен\envelope
\end{header}

\begin{affil}
\tsp{1}Евразийский национальный университет им. Л.Н. Гумилева, Астана, Казахстан,

\tsp{2}Общественный фонд «TEMS-Technology, Education and Mathematical Science», Астана, Казахстан,

\tsp{3}Казахский университет технологии и бизнеса им.К. Кулажанова, Астана, Казахстан,

\tsp{4}ТОО КМГ Инжиниринг, Aстана, Казахстан,

\tsp{5}НАО Кокшетауский университет им. Ш. Уалиханова, Кокшетау, Казахстан

\corrauthor{Корреспондент-автор:syerlan75@yandex.kz}
\end{affil}
...
\begin{header}
ЭКСТРАКЦИЯЛЫҚ ПРОЦЕСТІҢ КИНЕТИКАСЫНА НЕГІЗГЕН ЭКСТРАКЦИЯНЫҢ МАТЕМАТИКАЛЫҚ МОДЕЛІ
...
\begin{affil}
\tsp{1}Л.Н. Гумилев атындағы Еуразия ұлттық университеті Л.Н. Гумилев, Астана, Қазақстан,

\tsp{2}«TEMS-Технология, білім және математика ғылымы» қоғамдық қоры, Астана, Қазақстан,

\tsp{3}Қ. Құлажанов атындағы Қазақ технология және бизнес университетінің Астана, Қазақстан,

\tsp{4}«KMG Engineering» ЖШС, Астана, Қазақстан,

\tsp{5}Ш. Уалиханов атындағы Көкшетау университеті, Көкшетау, Қазақстан,
...
\begin{header}
MATHEMATICAL MODEL OF EXTRACTION BASED ON THE KINETICS OF THE EXTRACTION PROCESS

\tsp{1,2}K.M. Suleimenov,
\tsp{3}G.K. Mamytbekova,
\tsp{3}Zh. Nurymov,
\tsp{3,4}K.G. Satenov,
\tsp{3,4,5}Ye.M. Suleimen\envelope
\end{header}

\begin{affil}
\tsp{1}L.N. Gumilyov Eurasian National University, Astana, Kazakhstan,

\tsp{2}TEMS-Technology, «TEMS-Technology, Education and Mathematical Science», Education and Public Foundation, Astana, Kazakhstan,

\tsp{3}K. Kulajanov Kazakh University of Technology and Business, Astana, Kazakhstan,

\tsp{4}KMG Engineering LLP, Astana, Kazakhstan,
...
\begin{equation}
C_{x} = N_{1}e^{k_{1}t} + N_{2}e^{k_{2}t},
\end{equation}
...
\tcap{Таблица 1 - Лабораторное получение экстрактов из растительного сырья}
\begin{longtblr}[
  label = none,
  entry = none,
]{
  width = \linewidth,
  colspec = {Q[231]Q[113]Q[219]Q[206]Q[165]},
  cells = {c},
  cells = {font = \small},
  hlines,
  vlines,
}
\textbf{Название травы}                      & \textbf{Масса сырья, г} & \textbf{Масса неочищенного экстракта, г} & \textbf{Масса очищенного экстракта, г} & \textbf{Растворители}   \\
\textit{Achillea asiatica }Serg.             & 500                     & 60                                       & 38                                     & Этанол: хлороформ = 1:1 \\
\textit{Achillea nobilis }L.                 & 2000                    & 130                                      & 44                                     & Этанол: хлороформ = 1:1 \\
\textit{Achillea salicifolia }Besser         & 500                     & 57                                       &                                        & Этанол: хлороформ = 1:1 \\
\textit{Polygonum aviculare }L.              & 2000                    & 273                                      &                                        & Этанол: хлороформ = 1:1 \\
\textit{Polygonum acerosum }Ledeb. ex Meisn. & 1500                    & 109                                      &                                        & Этанол: хлороформ = 1:1 
\end{longtblr}
...
\[N_{2}\left( e^{0,8 \cdot 3} - 1 \right) = 60,\ N_{2} = \frac{60}{e^{0,8 \cdot 3} - 1} = \frac{60}{10} = 6\]
...
\begin{refs}
1. Handa S.S. et al. Extraction Technologies for Medicinal and
Aromatic Plants // Trieste: International Centre for Science and High
Technology.  - 2008. - 263 p.
...
8. -
e28947. DOI~\href{https://doi.org/10.1016/j.heliyon.2024.e28947}{10.1016/j.heliyon.2024.e28947}.
...
exchange resin // Separation and Purification Technology. - 2013. -
Vol.  102. - P.~163--172. DOI
...
массопереноса при экстракции в бидисперсном адсорбирующем поровом
объеме частиц масличного материала // Известия вузов. Пищевая
технология. - 2007. - № 2. - С.47- 66.

9. Lemoni, Z.; Kalantzi, S.; Lymperopoulou, T.; Tzani, A.;
Stavropoulos, G.; Detsi, A.; Mamma, D.Kinetic Modeling and Biological
Activities of Rosa canina L.Pseudo-Fruit Extracts Obtained via
...
fractionation of natural matter // The Journal of Supercritical
Fluids.  - 2006. - Vol.38(2).- P.146-166.
...
7. Bukin A.A., Beljaev P.S., Odnol' ko V.G., Tkach L.I., Shherbakov
S.A. Matematicheskaja model'{} massoperenosa pri mnogostupenchatoj
jekstrakcii iz rastitel' nogo syr' ja szhizhennym dioksidom ugleroda
// Izvestija vuzov. Pishhevaja tehnologija. - 2011. - № 2-3:
6970.{[}in Russian{]}

8. Vasilenko V.V., Koshevoj E.P., Kosachev V.S. Matematicheskaja
model'{} massoperenosa pri jekstrakcii v bidispersnom adsorbirujushhem
porovom ob\#eme chastic maslichnogo materiala // Izvestija
vuzov. Pishhevaja tehnologija. - 2007. - № 2. - S.47-66.  {[}in
Russian{]}
...
Сулейменов К.М. - кандидат физико-математических наук, PhD,
Евразийский национальный университет им. Л.Н. Гумилева, Астана,
Казахстан; Общественный фонд «TEMS-Technology, Education and
Mathematical Science», Астана, Казахстан, e-mail:
...
Уалиханова, Кокшетау, Казахстан, e-mail: Syerlan75@yandex.kz.

\hspace{1em}\emph{{\bfseries Information about the authors}}

Suleimenov K.M.- Candidate of Physics and Mathematics Sciences,PhD,
L.N.  Gumilyov Eurasian National University, Astana, Kazakhstan,
Public Foundation "TEMS-Technology, Education and Mathematical
Science", Astana, Kazakhstan, e-mail: kenessarymath@gmail.com;

Mamytbekova G.K. - Master of Veterinary Sciences, Kazakh University of
Technology and Business named after K. Kulajanov, Astana, Kazakhstan,
e-mail: gulnur4284@mail.ru;

Nurymov Zh. Zh. - Master of Chemical Sciences, Kazakh University of
Technology and Business named after K. Kulajanov, Astana, Kazakhstan,
e-mail: njd-jainar@mail.ru;
...
Kazakhstan, e-mail: K.Satenov@kmge.kz;
...
University, Kazakhstan, e-mail: Syerlan75@yandex.kz.
\end{info}
