...
\begin{header}
\swa{D.T. Begaliyev, N.M. Zhumagaliyev, A.S. Kupeshova, A.T. Zholbasarova, A.B. Kydrashov, B.Zh. Burkhanov, A.R. Abdiev}{THERMAL AND CRYOGENIC FRACTURE INTERACTIONS IN GRANITE: FRACTURE TOUGHNESS TESTS FOR GEOTHERMAL DEVELOPMENT}

\tsp{1}D.T. Begaliyev\envelope ,
\tsp{1}N.M. Zhumagaliyev,
\tsp{1}A.S. Kupeshova,
\tsp{2}A.T. Zholbasarova\envelope,
...
\tsp{3}Kyrgyz Mining and Metallurgical Institute named after academician U. Asanaliev, Bishkek, Kyrgyzstan

\corrauthor{Corresponding-authors:dastan.begaliyev@wkau.kz, a.kydrashov@mail.ru}
\end{affil}
...
\begin{header}
ГРАНИТТЕГІ ТЕРМИЯЛЫҚ ЖӘНЕ КРИОГЕНДІК СЫНЫҚТАРДЫҢ ӨЗАРА ӘРЕКЕТТЕСУІ: ГЕОТЕРМИЯЛЫҚ ДАМУҒА АРНАЛҒАН СЫНЫҚТАРДЫҢ БЕРІКТІГІН СЫНАУ
...
\tsp{2}«Ш. Есенов атындағы Каспий технологиялар және инжиниринг университеті» КеАҚ, Ақтау, Қазақстан,

\tsp{3}Академик У. Асаналиев атындағы Қырғыз тау-кен металлургиялық институты, Бішкек, Қырғызстан,
...
\begin{header}
ВЗАИМОДЕЙСТВИЕ ТЕРМИЧЕСКОГО И КРИОГЕННОГО РАЗРУШЕНИЯ ГРАНИТА: ИСПЫТАНИЯ НА ТРЕЩИНОСТОЙКОСТЬ ПРИ РАЗРАБОТКЕ ГЕОТЕРМАЛЬНЫХ МЕСТОРОЖДЕНИЙ
...
\begin{affil}
\tsp{1}НАО «Западно-Казахстанский аграрно-технический университет им. Жангир хана», Уральск, Казахстан,

\tsp{2}НАО «Каспийский университет технологии и инжиниринга им. Ш.Есенова»,Актау, Казахстан,

\tsp{3}Кыргызский горно-металлургический институт им. академика У.Асаналиева ,Бишкек, Кыргызстан,
...
\fig[0.6\textwidth]{g/image2}[Fig.1 - Granite specimen dimensions and setup]
...
\fig[0.6\textwidth]{g/image3}[Fig.2 - Load vs crack mouth opening curves from fracture toughness tests]
\fig[0.6\textwidth]{g/image4}[Fig.3 - Load vs axial displacement curves after fracture toughness tests]
...
\fig[0.6\textwidth]{g/image5}[Fig.4 - Mode I stress intensity factor vs crack mouth opening curves after fracture toughness tests]
\fig[0.6\textwidth]{g/image6}[Fig.5 - Fracture energy vs process after fracture toughness tests]
...
\tcap{Table 1 - Effect of increase in temperature along with LN\tsb{2} to the peak values of mode I intensity factor values}
\begin{longtblr}[
  label = none,
  entry = none,
]{
  width = \linewidth,
  colspec = {Q[94]Q[100]Q[142]Q[175]Q[210]Q[160]},
  cells = {c},
  cells = {font = \small},
  cell{3}{2} = {r=2}{},
  cell{3}{4} = {r=2}{},
...
\textbf{Specimen} & \textbf{Treatment} & \textbf{Peak value of KI}                               & \textbf{Stepwise Difference} & \textbf{Difference from Baseline} & \textbf{Average value of KI peaks}                      \\
~                 & ~                  & \textbf{(MPa*m}\textsuperscript{\textbf{1/2}}\textbf{)} & \textbf{(\%)}                & \textbf{(\%)}                     & \textbf{(MPa*m}\textsuperscript{\textbf{1/2}}\textbf{)} \\
1                 & No                 & 1.72                                                    & -                            & -                                 & 1.71                                                    \\
2                 &                    & 1.69                                                    &                              &                                   &                                                         \\
1                 & 100+LN2            & 1.41                                                    & -17.8                        & -17.8                             & 1.40                                                    \\
2                 &                    & 1.39                                                    & -17.7                        & -17.7                             &                                                         \\
1                 & 200+LN2            & 1.18                                                    & -16.5                        & -31.4                             & 1.19                                                    \\
2                 &                    & 1.21                                                    & -13.1                        & -28.4                             &                                                         \\
1                 & 400+LN2            & 0.93                                                    & -21.0                        & -45.8                             & 0.91                                                    \\
2                 &                    & 0.89                                                    & -26.5                        & -47.4                             &                                                         
\end{longtblr}
...
Uralsk, Kazakhstan, dastan.begaliyev@wkau.kz;

Zhumagaliyeva N.M.- NJSC ``West Kazakhstan Agrarian and Technical
University named after Zhangir khan'', master of technical sciences,
Uralsk, Kazakhstan, zhumagaliyeva.nurzhamal@inbox.ru;

Kupeshova A.S.- NJSC ``West Kazakhstan Agrarian and Technical
University named after Zhangir khan'', senior lecturer, Uralsk,
Kazakhstan, kupeshova.altynay@mail.ru;
...
Kydrashov A.B.- NJSC ``West Kazakhstan Agrarian and Technical
University named after Zhangir khan'', PhD doctor, associate
professor, Uralsk, Kazakhstan, a.kydrashov@mail.ru;

Burkhanov B.Zh.- NJSC ``West Kazakhstan Agrarian and Technical
University named after Zhangir khan'', candidate of technical
sciences, associate professor, Uralsk, Kazakhstan, aruka73@mail.ru;
...
Bishkek, Kyrgyzstan, arstanbek.abdiev@kstu.kg.
\end{info}
