...
{\bfseries ECONOMIC ANALYSIS OF DIGITAL HEALTHCARE DEVELOPMENT IN THE EAST
KAZAKHSTAN REGION}

{\bfseries \tsp{1}A.
Maldynova}{\bfseries \envelope ,
\tsp{2}N.
Aidargaliyeva}{\bfseries ,
\tsp{3}D.
Mussabalina}{\bfseries ,
\tsp{4}Zh.S.
Abdrakhmanova}{\bfseries ,
\tsp{5}T.Demesinov}

\emph{\tsp{1}Kenzhegali Sagadiyev University of
International Business, Almaty, Kazakhstan,\\
\tsp{2}L.N. Gumilyov Eurasian National University, Astana,
Kazakhstan,\\
\tsp{3}Abai Kazakh National Pedagogical University, Almaty,
Kazakhstan,\\
\tsp{4}D.Serikbayev East Kazakhstan Technical University,
Ust-Kamenogorsk, Kazakhstan,}

\emph{\tsp{5}Sh. Ualikhanov Kokshetau University, Kokshetau,
Kazakhstan}
...
Region, aiming to evaluate the impact of digitalization on healthcare
...
across healthcare institutions. Despite positive dynamics, challenges
persist: insufficient funding for ICT, shortage of cybersecurity
specialists, and limited training opportunities.
...
socio-economic development, digitalization, information and
communication technologies.

{\bfseries ШЫҒЫС ҚАЗАҚСТАН ОБЛЫСЫНДАҒЫ ЦИФРЛЫҚ ДЕНСАУЛЫҚ САҚТАУДЫҢ ДАМУЫНЫҢ
ЭКОНОМИКАЛЫҚ ТАЛДАУЫ}

\tsp{1}{\bfseries А.В. Малдынова\envelope ,
\tsp{2}Н. Айдарғалиева, \tsp{3}Д.Мұсабалина,
\tsp{4}Ж.С. Әбдрахманова, \tsp{5}Т.Ж.Демесинов}

\emph{\tsp{1}Кенжегали Сагадиев атындағы Халықаралық бизнес
университеті, Алматы, Қазақстан,\\
\tsp{2}Л.Н. Гумилев атындағы Еуразия ұлттық университеті,
Астана, Қазақстан,\\
\tsp{3}Абай атындағы Қазақ ұлттық педагогикалық
университеті, Алматы, Қазақстан,\\
\tsp{4}Д.Серікбаев атындағы Шығыс Қазақстан техникалық
университеті, Өскемен, Қазақстан,}

\emph{\tsp{5}Ш. Уәлиханов атындағы Көкшетау университеті,
Көкшетау, Қазақстан,}

e-mail: maldynova.a@uib.kz
...
экономикасы, {\bfseries электрондық} денсаулық сақтау,
әлеуметтік-экономикалық даму, цифрландыру, ақпараттық-коммуникациялық
технологиялар.

{\bfseries ЭКОНОМИЧЕСКИЙ АНАЛИЗ РАЗВИТИЯ ЦИФРОВОГО ЗДРАВООХРАНЕНИЯ В
ВОСТОЧНО-КАЗАХСТАНСКОЙ ОБЛАСТИ}

{\bfseries \tsp{1}А.В. Малдынова\envelope ,
\tsp{2}Н. Айдаргалиева, \tsp{3}Д. Муссабалина,
\tsp{4}Ж.С. Абдрахманова, \tsp{5}Т.Ж.Демесинов}

\emph{\tsp{1}Университет международного бизнеса имени
Кенжегали Сагадиева, Алматы, Казахстан,\\
\tsp{2}Евразийский национальный университет имени Л.Н.
Гумилёва, Астана, Казахстан,\\
\tsp{3}Казахский национальный педагогический университет
имени Абая, Алматы, Казахстан,\\
\tsp{4}Восточно-Казахстанский технический университет им. Д.
Серикбаева, Усть-Каменогорск, Казахстан,}

\emph{\tsp{5}Кокшетауский университет имени Ш. Уалиханова,
Кокшетау, Казахстан,}
...
Данное исследование сосредоточено на Восточно-Казахстанской области и
...
электронное здравоохранение, социально-экономическое развитие,
...
{\bfseries Table 1 - ICT specialists and knowledge (including public
administration organizations), their changes over 5 years}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2497}}
...
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1761}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1328}}@{}}
%% \toprule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries ~Indicator} & {\bfseries Number of organizations with ICT
%% specialists, units} & {\bfseries Number of employees with computer
%% literacy, people} & {\bfseries Number of specialists in information
%% security, people} & {\bfseries Number of employees who completed computer
%% literacy training during the reporting year, people} & {\bfseries Need for
%% ICT specialists, people} \\
...
%% Healthcare activities, in the Republic of Kazakhstan & 825 & 316841 &
%% 571 & 9569 & 271 \\
...
%% Healthcare activities, in the Republic of Kazakhstan & 642 & 189 523 &
%% 104 & 24 300 & 325 \\
%% East Kazakhstan region & 508 & 90 784 & 21 & 4 455 & 427 \\
%% Healthcare & 34 & 12 234 & 1 & 751 & 20 \\
%% \multicolumn{6}{@{}>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{1.0000} + 10\tabcolsep}@{}}{%
%% {\bfseries Changes}} \\
%% Republic of Kazakhstan & 2,49\% & 38,77\% & 412,59\% & -72,45\% &
%% -27,39\% \\
%% Healthcare activities, in the Republic of Kazakhstan & 28,50\% & 67,18\%
%% & 449,04\% & -60,62\% & -16,62\% \\
%% East Kazakhstan region & -11,02\% & 73,32\% & 971,43\% & -85,01\% &
%% -26,46\% \\
...
{\bfseries Table 2 - Comparative assessment of digital healthcare
indicators across selected regions of Kazakhstan}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2960}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1722}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.0985}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1232}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1525}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1576}}@{}}
%% \toprule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries Indicator} & {\bfseries East Kazakhstan Region} & {\bfseries Astana} &
%% {\bfseries Almaty} & {\bfseries Karaganda Region} & {\bfseries National
%% Average} \\
%% Growth in computer literacy among healthcare workers (2020-2024) & High
%% & High & High & Medium--High & Medium \\
%% ICT expenditures in healthcare & Low / Declining & High & High & Medium
%% & Moderate (Increasing) \\
%% Availability of ICT specialists & Low & High & High & Medium & Medium \\
%% Internet connectivity of healthcare facilities & High & Very High & Very
%% High & High & Medium--High \\
%% Adoption of telemedicine and digital services & Medium & Very High &
%% High & Medium & Medium \\
%% Level of interoperability between medical systems & Low--Medium & High &
%% Medium--High & Medium & Medium \\
%% Cybersecurity capacity & Very Low & High & Medium--High & Medium &
%% Low--Medium \\
%% \multicolumn{6}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{1.0000} + 10\tabcolsep}@{}}{%
%% \emph{Compiled by the authors}} \\
%% \end{longtable}
...
{\bfseries Fig.1 - Forecast of digitally competent healthcare workers in
the East Kazakhstan Region (2020-2030)}
...
{\bfseries Fig.2 - Dynamics of changes in ICT costs in the healthcare
sector, in the East Kazakhstan region}
...
{\bfseries Fig.3 - Volume of services rendered in the field of healthcare
and provision of social services by types of activity in East Kazakhstan
region, thousand tenge}
...
{\bfseries Fig.4 - Structure of rendered services in the field of
healthcare in the East Kazakhstan region,}
...
{\bfseries Table 3 - Main indicators of the health of the population of the
East Kazakhstan region}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.5271}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1109}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1206}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1206}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1207}}@{}}
%% \toprule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries Name of indicators} & {\bfseries 2021} & {\bfseries 2022} &
%% {\bfseries 2023} & {\bfseries 2024} \\
%% Birth rate, \% per 1000 people (15--49) & 66,29 & 66,65 & 67,87 &
%% 71,13 \\
%% Death rate, \% per 1000 people & 10,29 & 10,36 & 12,06 & 12,80 \\
%% Natural increase rate, \% per 1000 people & 56,00 & 56,29 & 55,81 &
%% 58,33 \\
%% Maternal mortality rate, \% per 1000 live births & 34,3 & 23,5 & 44,9 &
%% 50,0 \\
%% Infant mortality rate, \% per 1000 live births & 7,28 & 7,99 & 8,24 &
%% 7,4 \\
%% Tuberculosis incidence, per 100 thousand people & 45,8 & 39,65 & 33,5 &
%% 27,5 \\
%% including tuberculosis mortality & 2,1 & 2,0 & 2,0 & 1,9 \\
%% Malignant diseases, per 100 thousand people & 321,54 & 295,26 & 286,05 &
%% 277,18 \\
%% incl. Mortality from malignant diseases & 137,42 & 128,31 & 128,32 &
%% 125,63 \\
%% Cystolic diseases, per 100 thousand people & 4634,5 & 3671,05 & 3650,25
%% & 3340,39 \\
%% incl. mortality from CDS & 255,88 & 304,63 & 335,93 & 322,83 \\
%% Accidents, injuries, poisonings, per 100 thousand people & 242 & 282 &
%% 302 & 314 \\
%% incl. mortality from accidents, injuries and poisonings & 20 & 21 & 14 &
%% 24 \\
...
{\bfseries Fig.5 - Dynamics of changes in mortality rates relative to the
number of specialists in the field of ICT health care in the East
Kazakhstan region}
...
29.08.2025.23.Ministry of Health of the Republic of Kazakhstan. State Program for
...
2025. URL: \href{https://damumed.kz/\#_blank}{https://damumed.kz}. -Дата
...
28. Damumed. Oficial' nyj sajt Edinoj medicinskoj
informacionnoj sistemy Kazahstan

2025. URL: https://damumed.kz. - Data obrashhenija: 29.08.2025. {[}in
Russian{]}
...
Кенжегали Сагадиева, Алматы, Казахстан, e-mail:
maldynova.a@uib.kz;

Айдаргалиева Н. - PhD, доцент, Евразийский национальный университет им.
Л.Н. Гумилёва, Астана, Казахстан, e-mail:
aidargaliyeva@enu.kz;
...
Maldynova A.- PhD, Associate Professor, Kenzhegali Sagadiyev University
of International Business, Almaty, Kazakhstan, e-mail:
maldynova.a@uib.kz;

Aidargaliyeva N. - PhD, Associate Professor, L.N. Gumilyov Eurasian
National University, Department of Finance, Astana, Kazakhstan, e-mail:
aidargaliyeva@enu.kz;
...
Demessinov T. - Candidate of Economic Sciences, Associate Professor, Sh.
Ualikhanov Kokshetau University,

Kokshetau, Kazakhstan., e-mail:
demesinov73@list.ru.\
