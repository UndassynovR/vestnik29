...
{\bfseries DIGITALIZATION OF SCIENCE AS A TOOL FOR INCREASING THE
COMPETITIVENESS OF THE ECONOMY OF THE REPUBLIC OF KAZAKHSTAN}

{\bfseries D.A.Turganbayev}{\bfseries \envelope ,B.K.
Isayeva}{\bfseries ,
M.O.
Keznhegul}{\bfseries ,
D.A.
...
development and scientific modernization strategies, faces a number of
...
innovation, investment, artificial intelligence.

{\bfseries ҒЫЛЫМДЫ ЦИФРЛАНДЫРУ ҚАЗАҚСТАН РЕСПУБЛИКАСЫНЫҢ ЭКОНОМИКАСЫНЫҢ
БӘСЕКЕГЕ ҚАБІЛЕТТІЛІГІН АРТТЫРУ ҚҰРАЛЫ РЕТІНДЕ}

{\bfseries Д.Ә. Турғанбаев\envelope , Б.К.Исаева, М.О.Кенжеғұл,
Д.А.Сейтхожина}
...
{\bfseries ЦИФРОВИЗАЦИЯ НАУКИ КАК ИНСТРУМЕНТ ПОВЫШЕНИЯ
КОНКУРЕНТОСПОСОБНОСТИ ЭКОНОМИКИ РЕСПУБЛИКИ КАЗАХСТАН}

{\bfseries Д.Ә. Турғанбаев\envelope , Б.К. Исаева, М.О. Кенжеғұл,
Д.А. Сейтхожина}

\emph{Евразийский национальный университе им.Л.Н.Гумилева, Астана,
Казахстан,}
...
C=β0+β1D+β2R+β3B+εC = \textbackslash beta\_0 + \textbackslash beta\_1 D
+ \textbackslash beta\_2 R + \textbackslash beta\_3 B +
\textbackslash varepsilonC=β0+β1D+β2R+β3B+ε

where:

- CCC - Digital competitiveness index (IMD Digital Competitiveness);

- DDD - science digitalization index (0-1);

- RRR - R\&D expenditures (\% of GDP);

- BBB - share of joint science and business projects (\% of all R\&D);

- ε\textbackslash varepsilonε - an accidental mistake.

The data for 2024, presented in the table below, was used for
quantitative assessment.

{\bfseries Table 1 - Comparison of indicators of the Republic of Kazakhstan
and the Republic of Korea (2024)}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3450}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3450}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3100}}@{}}
%% \toprule\noalign{}
...
{\bfseries Table 2 - Comparison of key areas of digitalization of science:
Kazakhstan and the Republic of Korea in 2024}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2935}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2888}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4177}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries The direction of digitalization}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Republic of Kazakhstan}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Republic of Korea}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% Unified Digital Science Platform & Missing, using disparate ICS & KISTI,
%% NTIS -- integrated platforms \\
%% Open access to data and publications & Partial, non-integrated & Full,
%% through the state platform \\
%% Automating grant allocation & Partially implemented (Science Fund) &
%% Fully automated via KIAT \\
%% Integration of science and business & Low, 12\% of projects are joint &
%% High, more 35 \% \\
%% The use of AI and Big Data in science & Local pilot projects & At the
%% level of national scientific programs \\
%% Digital certification of results & Practically absent & Mandatory for
%% all R\&D \\
%% Digital skills of scientific staff & Limited, fragmentary training &
%% Integrated into PhD programs and Master' s degree
%% programs \\
%% Standards of open science & They are not legally fixed & Implemented and
%% mandatory since 2020 \\
%% \multicolumn{3}{@{}>{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{1.0000} + 4\tabcolsep}@{}}{%
%% \emph{Note -- Developed by the authors}} \\
%% \end{longtable}
