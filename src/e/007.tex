...
{\bfseries Analysis of the Effect of CULTURAL ADAPTATION on Academic
Performance}

{\bfseries \tsp{1}D.Satybaldiyeva}{\bfseries \envelope ,
\tsp{2}B.Keneshbayev}{\bfseries ,
\tsp{3}R.Tazhibayeva}{\bfseries ,
\tsp{3}S.Kaltayeva}{\bfseries ,
\tsp{4}A.Mutaliyeva}

\emph{\tsp{1} Satbayev University, Almaty, Kazakhstan,}

\emph{\tsp{2} Akhmet Yassawi University, Turkestan,
Kazakhstan,}

\emph{\tsp{3} International University of Tourism and
Hospitality, Turkestan, Kazakhstan,}
...
{\bfseries АНАЛИЗ ВЛИЯНИЯ КУЛЬТУРНОЙ АДАПТАЦИИ НА АКАДЕМИЧЕСКУЮ
УСПЕВАЕМОСТЬ}

{\bfseries \tsp{1}Д. Сатыбалдиева\envelope ,
\tsp{2}Б.Кенешбаев, \tsp{3}Р.Тажибаева,
\tsp{3}С.Калтаева, \tsp{4}А.Муталиева}

\emph{\tsp{1}Университет Сатпаева, Алматы, Казахстан,}

\emph{\tsp{2} Университет Ахмеда Ясави, Туркестан,
Казахстан,}

\emph{\tsp{3} Международный университет туризма и
гостеприимства, Туркестан, Казахстан,}

\emph{\tsp{4} Региональный инновационный университет,
Шымкент, Казахстан,}

\envelope e-mail: d.satybaldiyeva@satbayev.university
...
{\bfseries МӘДЕНИ БЕЙІМДЕЛУДІҢ АКАДЕМИЯЛЫҚ ҮЛГЕРІМГЕ ӘСЕРІН ТАЛДАУ}

{\bfseries \tsp{1}Д. Сатыбалдиева\envelope ,
\tsp{2}Б.Кенешбаев, \tsp{3}Р. Тажибаева,
\tsp{3}С.Калтаева, \tsp{4}А.Муталиева}

\emph{\tsp{1}Сәтбаев университеті, Алматы, Қазақстан,}

\emph{\tsp{2} Ахмет Ясауи университеті, Түркістан,
Қазақстан,}

\emph{\tsp{3} Халықаралық туризм және меймандостық
...
{\bfseries Fig.1 - The process of developing cultural intelligence}

\emph{Source: Compiled by the authors based on references {[}11,12{]}}
...
{\bfseries Table 1 - Research conducted in the field of cultural
intelligence}
...
%% {\bfseries Purpose of the research}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% Identify the relationship between the five major personality factors and
%% dimensions of cultural intelligence
%% \end{minipage} \\
%% & \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries The result of the research}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% Openness to experience was found to be an important personality factor,
%% related to an individual' s ability to interact
%% effectively with people from different cultures. There was a positive
%% relationship between mindfulness and high metacognitive cultural
%% intelligence, and high adaptability was also found to be associated with
%% behavioral cultural intelligence
%% \end{minipage} \\
%% & \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Characteristics of participants}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% 338 management undergraduate students participated
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
...
%% } \\
%% \multirow{3}{=}{{\bfseries 2}} & {\bfseries Purpose of the research} &
%% Identifying the role of cultural intelligence in intercultural
%% leadership activities and practices \\
%% & {\bfseries The result of the research} & It has been found that a
%% leader' s cultural intelligence is important in managing
%% employees who have grown up in different cultural environments, and that
%% the development of cultural intelligence increases in direct proportion
%% to the time they spend living in another culture \\
%% & {\bfseries Characteristics of participants} & 32 Western European
%% managers (including 26 Australian managers) and 19 Chinese managers
%% participated \\
%% \multicolumn{3}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{1.0000} + 4\tabcolsep}@{}}{%
%% } \\
%% \multirow{3}{=}{{\bfseries 3}} & {\bfseries Purpose of the research} &
%% Determining the relationship between employees'{}
%% academic performance and cultural intelligence \\
%% & {\bfseries The result of the research} & A positive relationship was
%% found between employees'{} academic performance and the
%% motivational dimension of cultural intelligence. However, a negative
%% relationship was found between the behavioral dimension of cultural
%% intelligence \\
%% & {\bfseries Characteristics of participants} & Research conducted on
%% declining industrial sectors \\
%% \multicolumn{3}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{1.0000} + 4\tabcolsep}@{}}{%
%% } \\
%% \multirow{3}{=}{{\bfseries 4}} & {\bfseries Purpose of the research} &
%% Identifying the relationship between cultural intelligence and
%% organizational commitment (dependence) \\
%% & {\bfseries The result of the research} & A positive relationship was
%% found between organizational commitment (dependence) and informational,
%% motivational, and behavioral dimensions of cultural intelligence. It was
%% found that the greater the knowledge about culture and the nature of
%% cultural differences, the higher the commitment (dependence) to the
%% organization \\
%% & {\bfseries Characteristics of participants} & 100 university employees in
%% Iran participated \\
%% \multicolumn{3}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{1.0000} + 4\tabcolsep}@{}}{%
...
{\bfseries Table 2 - Demographic features and characteristics of
participants}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1318}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1812}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1662}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1320}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2084}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1805}}@{}}
%% \toprule\noalign{}
%% \multicolumn{2}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3130} + 2\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
...
%% {\bfseries (\%)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Eliglibe Share}
%% 
%% {\bfseries (\%)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Total Share}
%% 
%% {\bfseries (\%)}
%% \end{minipage} \\
%% \midrule\noalign{}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% \multirow{3}{=}{{\bfseries Gender}} & {\bfseries Female} & 145 & 57,3 & 57,3 &
%% 57,3 \\
%% & {\bfseries Male} & 108 & 42,7 & 42,7 & 100,0 \\
%% & {\bfseries All} & 253 & 100,0 & 100,0 & \\
%% \multirow{6}{=}{{\bfseries Age}} & {\bfseries 18-24} & 118 & 46,6 & 46,6 &
%% 46,6 \\
%% & {\bfseries 25-31} & 94 & 37,2 & 37,2 & 83,8 \\
%% & {\bfseries 32-38} & 31 & 12,3 & 12,3 & 96,0 \\
%% & {\bfseries 39-45} & 4 & 1,6 & 1,6 & 97,6 \\
%% & {\bfseries 46 ≤} & 6 & 2,4 & 2,4 & 100,0 \\
%% & {\bfseries All} & 253 & 100,0 & 100,0 & \\
%% \multirow{5}{=}{{\bfseries Country}} & {\bfseries Turkey} & 33 & 13,0 & 13,0 &
%% 13,0 \\
%% & {\bfseries Russia, China, Mongolia} & 100 & 39,5 & 39,5 & 52,6 \\
%% & {\bfseries Central Asia} & 106 & 41,9 & 41,9 & 94,5 \\
%% & {\bfseries Other} & 14 & 5,5 & 5,5 & 100,0 \\
%% & {\bfseries All} & 253 & 100,0 & 100,0 & \\
%% \multirow{6}{=}{{\bfseries GPA}} & {\bfseries 1.50 - 1.99} & 2 & 0,8 & 0,8 &
%% 0,8 \\
%% & {\bfseries 2.00 - 2.49} & 16 & 6,3 & 6,3 & 7,1 \\
%% & {\bfseries 2.50 - 2.99} & 33 & 13,0 & 13,0 & 20,2 \\
%% & {\bfseries 3.00 - 3.49} & 107 & 42,3 & 42,3 & 62,5 \\
%% & {\bfseries 3.50 - 4.00} & 95 & 37,5 & 37,5 & 100,0 \\
%% & {\bfseries All} & 253 & 100,0 & 100,0 & \\
%% \multicolumn{6}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{1.0000} + 10\tabcolsep}@{}}{%
%% \emph{Note:} Compiled by the author} \\
%% \end{longtable}
...
{\bfseries Table 3 - Basic statistical information regarding cultural
intelligence, cultural adaptation}

{\bfseries and their subscales}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4769}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1077}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2616}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1539}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% N
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Arithmetic mean}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Standard deviation}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
...
{\bfseries Table 4 - Results of correlation analysis on cultural
intelligence, its subscales, and academic performance}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0449}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.3432}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1044}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1044}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1044}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1045}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1044}}
...
%% & \\
%% 6 & Behavioral intelligence & ,217** & ,721** & ,241** & ,362** & ,441**
%% & 1 \\
...
{\bfseries Tablе- Results of correlation analysis regarding cultural
adaptation, its subscales, and academic performance}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0462}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.4308}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1077}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1077}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1077}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1078}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0923}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% №
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
%% \endlastfoot
%% 1 & Average grade & 1 & & & & \\
%% 2 & Cultural adaptation & ,203** & 1 & & & \\
%% 3 & Physical adaptation & ,220** & ,816** & 1 & & \\
%% 4 & Social adaptation & ,132* & ,817** & ,507** & 1 & \\
%% 5 & Work environment adaptation & ,160* & ,851** & ,572** & ,510** &
%% 1 \\
...
{\bfseries Table 6 - Correlation analysis between cultural intelligence and
its subscales and cultural adaptation and its subscales}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0454}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.2416}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0923}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0754}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0755}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0923}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0906}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0907}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0738}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0620}}
%%   >{\centering\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0604}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% №
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% & & & \\
%% 6 & Behavioral Intelligence & ,721** & ,266** & ,241** & ,362** & ,441**
%% & 1 & & & \\
%% 7 & Physical Adaptation & ,298** & ,816** & ,173** & ,238** & ,174** &
%% ,262*
%% 
%% * & 1 & & \\
%% 8 & Social Adaptation & ,271** & ,817** & ,111* & ,260** & ,180** &
%% ,222*
%% 
%% * & ,507*
%% 
%% * & 1 & \\
%% 9 & Work Environment Adaptation & ,278** & ,851** & ,149* & ,272** &
%% ,188** & ,185*
%% 
%% * & ,572*
%% 
...
%% 
%% ** & 1 \\
%% \multicolumn{11}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{1.0000} + 20\tabcolsep}@{}}{%
%% \emph{Note:} Compiled by the author} \\
%% \end{longtable}
...
{\bfseries Table 7 - Relationships and coefficients in a structural model}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1333}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0834}}
...
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0999}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Prediction coefficient}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Standard error}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries C.R.}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% P
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% Average grade & <-\/-\/- & Cultural Intelligence & ,306 & ,119 &
%% 2,561 & ,010 \\
%% Average grade & <-\/-\/- & Cultural Adaptation & ,233 & ,103 &
%% 2,266 & ,023 \\
%% \multicolumn{7}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{1.0000} + 12\tabcolsep}@{}}{%
%% \emph{Note:} Compiled by the author} \\
%% \end{longtable}
