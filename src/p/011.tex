...
\begin{header}
\swa{}{APPLICATION OF MOLECULAR HYDROGEN IN FOOD PRODUCTION AND PRESERVATION: CURRENT TRENDS AND FUTURE PROSPECTS (REVIEW)}
...
A.R. Okassov,
B.T. Bolkenov,
K.S. Bekbayev\envelope
\end{header}

\begin{affil}
Shakarim University, Semey, Kazakhstan

\corrauthor{Corresponding-author: k\_bekbaev@mail.ru}
\end{affil}

The modern food industry faces many challenges, including accelerated
processes of oxidative degra\-dation of lipids and proteins, active
reproduction of pathogenic microflora, limited shelf life and
accumu\-lation of toxic compounds, which necessitates the introduction of
...
with natural bio\-chemical processes. Studies show that the use of H₂ in
...
activity, antimicrobial properties, bio\-genic amines, meat and dairy
products, hydrogen-rich water (HRW), food safety.

\begin{header}
ТАМАҚ ӨНІМДЕРІН ӨНДІРУДЕ ЖӘНЕ САҚТАУДА МОЛЕКУЛАЛЫҚ СУТЕКТІ ҚОЛДАНУ: ҚАЗІРГІ ЗАМАНҒЫ ҮРДІСТЕР МЕН ПЕРСПЕКТИВАЛАР (ШОЛУ)
...
\begin{header}
ПРИМЕНЕНИЕ МОЛЕКУЛЯРНОГО ВОДОРОДА В ПРОИЗВОДСТВЕ И СОХРАНЕНИИ ПРОДУКТОВ ПИТАНИЯ: СОВРЕМЕННЫЕ ТЕНДЕНЦИИ И ПЕРСПЕКТИВЫ (ОБЗОР)
...
А.Р.Окасов,
Б.Т.Болкенов,
К.С.Бекбаев\envelope
\end{header}

\begin{affil}
Шәкәрім Университет, Семей, Казахстан,
...
\fig[0.5\textwidth]{p/image38}[Fig.1 - Applications of Molecular Hydrogen in Food Production and Preservation]
...
Daiyrbekova A. - Master student, Shakarim University, Semey,
Kazakhstan, e-mail: a.dayirbekova\_03@mail.ru:
...
Okassov A.- PhD student, Shakarim University, Semey, Kazakhstan,
e-mail: oar20@mail.ru.

\hspace{1em}\emph{{\bfseries Сведения об авторах}}

Мелісова A.A.-докторант, Шәкәрім Университет, Семей, Казахстан,
e-mail: aknurmelissova@gmail.com;
...
Окасов А.Р. - докторант, Шәкәрім Университет, Семей, Казахстан,
e-mail: oar20@mail.ru.
\end{info}
