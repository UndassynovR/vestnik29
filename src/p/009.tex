...
{\bfseries ӨСІМДІК ШИКІЗАТЫ НЕГІЗІНДЕ ЭМУЛЬСИЯЛЫҚ ӨНІМДЕРДІ АЛУ}

{\bfseries ТЕХНОЛОГИЯСЫН ӘЗІРЛЕУ}

{\bfseries \tsp{1}М.Е.
Смагулова}{\bfseries ,\tsp{2}
Ш.Ж.
Жасқайрат}{\bfseries \envelope ,
\tsp{2}Н.С.Машанова}{\bfseries ,
\tsp{2}М.Е.
Бекболатова}

\emph{К.Кулажанов атындағы Қазақ технология және бизнес университеті,
Астана, Қазақстан,}

\emph{С.Сейфуллин атындағы Қазақ агротехникалық зерттеу университеті,
Астана, Қазақстан}
...
{\bfseries \tsp{1}М.Е. Смагулова, \tsp{2}Ш.Ж.
Жасқайрат\envelope , \tsp{2}Н.С. Машанова,
...
{\bfseries \tsp{1}M.E. Smagulova, \tsp{2}Sh.Zh.
Zhaskairat\envelope , \tsp{2}N.S. Mashanova,
\tsp{2}M.E. Bekbolatova}

\emph{\tsp{1}K. Kulazhanov\tsp{1}Kazakh
University of Technology and Business, Astana, Kazakhstan,}
...
%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2041}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2456}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2370}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3134}}@{}}
%% \toprule\noalign{}
...
{\bfseries 1- сурет. Primula veris сығындысын дайындау}
...
{\bfseries 1-кесте. - P. Veris-те анықталған фенолдық қосылыстар (мг/100
г)}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5922}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4078}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Атаулары}
...
{\bfseries 2-сурет. Primula veris сығындысындағы фенолды қосылыстардың
хроматограммасы}
...
{\bfseries 2 -- кесте. P. Veris-те анықталған суда еритін витаминдер
(мг/100 г) {[}8{]}.}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5172}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4828}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Атаулары
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries 3 - сурет. Primula veris сығындысындағы суда еритін
витаминдердің хроматограммасы}
...
{\bfseries 3- кесте. Эмульсиялық өнімдердің рецептуралары}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3560}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2882}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3559}}@{}}
%% \toprule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries Шикізат атауы} & {\bfseries Бақылау үлгісі} & {\bfseries Май
%% қоспасынан жасалған өнім} \\
...
{\bfseries 4- кесте. Эмульсиялық өнімдердің органолептикалық көрсеткіштері}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2235}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2243}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2751}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1424}}
...
%% \end{minipage}} &
%% \multirow{2}{=}{\centering\arraybackslash \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Тәжірибе үлгісі}
%% \end{minipage}} &
%% \multirow{2}{=}{\centering\arraybackslash \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Бақылау үлгісі}
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2771} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Орташа балл}
%% \end{minipage}} \\
%% & & & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Тәжірибе}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% Сыртқы түрі, консистенциясы & Біртекті қаймақ тәрізді, біртекті &
%% Біртекті қаймақ тәрізді, біртекті & 4,9 & 4 \\
%% Дәмі мен иісі & Нәзік дәм, ащы емес, қышқылдау & Жағымды, өткірлеу,
%% қышаның дәмі бар & 4,98 & 3,9 \\
...
{\bfseries 5 --кесте. Эмульсиялық өнімдердің физика-химиялық көрсеткіштері}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4091}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3030}}
%%   >{\centering\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2878}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% Көрсеткіштер атауы
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries 6- кесте. Эмульсиялық өнімнің тағамдық және энергетикалық
құндылығы}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1814}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1062}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1213}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1667}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2087}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2157}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\centering\arraybackslash \begin{minipage}[b]{\linewidth}\centering
%% Өнім
%% \end{minipage}} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3942} + 4\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Массалық үлесі, \%
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.4244} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Энергетикалық құндылық (100 г.)
%% \end{minipage}} \\
%% & \begin{minipage}[b]{\linewidth}\centering
%% май
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries 7- кесте. Эмульсиялық өнімдердің май қышқылдық құрамы}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3030}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2424}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2122}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2424}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\centering\arraybackslash \begin{minipage}[b]{\linewidth}\centering
...
%% Белгіленуі
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.4546} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Нәтижесі
%% \end{minipage}} \\
%% & & \begin{minipage}[b]{\linewidth}\centering
...
11. Эмульсия тәрізді майлы тағамдық өнім. Пайдалы модельге патент №7144,
27.05.2022. \emph{{\bfseries Авторлар туралы мәліметтер}}
...
Smagulova M. E.- candidate of chemical sciences, Leading Researcher, K.
...
Kazakh Agrotechnical Research University, 3rd-year PhD student, Astana,
Kazakhstan, e-mail:
shynarai\_92@mail.ru;
...
Bekbolatova M.E. - master of technical sciences, Saken Seifullin Kazakh
Agrotechnical Research University, 3rd-year PhD student, Astana,
Kazakhstan , e-mail:
mariambekbolatova93@gmail.com.\
