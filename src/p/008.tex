...
\begin{header}
\swa{}{EXPERIMENTAL STUDIES OF THE GASTROINTESTINAL SYSTEM - QARTA OF THE HORSE}

\tsp{1}A.T. Kostanova\envelope,
...
\tsp{2}JSC « K.Kulazhanov Kazakh University of Technology»,Astana, Kazakhstan

\corrauthor{Corresponding author: anel\_kostanova@mail.ru}
\end{affil}

The present study provides a comprehensive investigation into the
biochemical, nutritional, and physi\-cochemical properties of qarta, the
...
\begin{header}
ЭКСПЕРИМЕНТАЛЬНОЕ ИССЛЕДОВАНИЕ ЖЕЛУДОЧНО-КИШЕЧНОГО ТРАКТА ЛОШАДИ ҚАРТА
...
\begin{header}
ЖЫЛҚЫНЫҢ АСҚАЗАН-ІШЕК ЖОЛЫ - ҚАРТАНЫ ЭКСПЕРИМЕНТТІК ЗЕРТТЕУ
...
\[x_{1} = \frac{m_{1} - m_{2}}{\,m_{1} - m\,} \cdot 100\]

where, \(x_{1}\) - moisture content, \%;

\(m_{1}\) - weight of the bunker with the sample before drying,
g;

\(m_{2}\) - mass of the bucket with the sample after drying, g;
...
\[x_{2} = \frac{m_{1} - m_{2}}{m_{0}} \cdot 100 \]

where, x\tsb{2} - fat content, \%;

\(m_{1}\) - weight of bouquet with sample after drying before
degreasing, g;

\(m_{2}\) - mass of the bunker with the sample after
degreasing, g;

\(m_{0}\) - weight of the sample, g.
...
\[x_{3} = \frac{m_{1} - m_{2}}{m_{0}} \cdot 100 \]

where, \(x_{3}\) - ash content, \%;

\(m_{1}\) - mass of ash, g;

\(m_{2}\) - mass of magnesium oxide obtained after
mineralisation of magnesium acetate solution, g;

\(m_{0}\) - mass of suspension, g.
...
\[x = 100 - \left( x_{1} + x_{2} + x_{3} \right) \]

where, x - protein content, \%;

\(x_{1}\) - moisture content, \%;
...
\fig{p/image24}[{\bfseries Horse (1-3 years)}\hspace{3cm}{\bfseries Carcass of horse}\hspace{2cm}{\bfseries Digestive system of horse}\vspace{0.5em}\\Fig.1 - Anatomical diagram of the horse and its gastrointestinal system]
...
\fig[0.57\textwidth]{p/image25}[Fig.2 - The anatomy of the gastrointestinal tract in horse]

\begin{figs}[Fig.3 - Intestinal raw materials of horse meat - qarta (a) external; b) internal)]
  \fig[0.40\textwidth]{p/image26}[a)]
  \fig[0.38\textwidth]{p/image27}[b)]
\end{figs}
...
\fig[0.4\textwidth]{p/image28}[Fig.4 - Cross-sectional view of Qarta, showing fat-muscle structure]
...
\tcap{Table 1 - pH, a\tsb{w} content of fresh gastrointestinal tract of horse after thawing}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\textbf{Name of indicators, unit of measurement} & \textbf{Actual results} \\
...
\tcap{Table 2 - pH, a\tsb{w} and approximate content in final boiled gastrointestinal tract}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 3 - Levels of cholesterol (mg/100 g) in final boiled meat products}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 4 - Content of fatty acids (\%) of gastrointestinal raw material of final boiled qarta}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 5 - Free amino acids (mg/100g) in final boiled qarta}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\textbf{Name of indicators} & \textbf{Actual results} \\
ASP                         & 1334.96±133.50          \\
THR                         & 645.45±64.55            \\
SER                         & 607.69±60.77            \\
GLU                         & 2056.64±205.66          \\
...
professor, NJSC «S.Seifullin Kazakh Agrotechnical Research
University», Astana, Kazakhstan, e-mail: baytukenova75@mail.ru;

Baytukenova S.B. - candidate of technical sciences, associate
professor, JSC «K.Kulazhanov Kazakh University of Technology and
Business», Astana, Kazakhstan, e-mail: saule7272@mail.ru.
...
Кулажанова», Астана, Казахстан, e-mail: saule7272@mail.ru.
\end{info}
