...
\begin{header}
\swa{A.S. Seitenov, T.K. Zhukabayeva}{AUTOMATION OF THE PROCESSES BASED ON MACHINE LEARNING FOR
TELEMEDICINE INFORMATION SYSTEM}

\tsp{1,2}A.S. Seitenov\envelope,
\tsp{1}T.K. Zhukabayeva
\end{header}
...
challe\-nges persist in automating these systems, particularly in areas of
...
learning, healthcare information sys\-tem, remote patient monitoring.

\begin{header}
АВТОМАТИЗАЦИЯ ПРОЦЕССОВ НА ОСНОВЕ МАШИННОГО ОБУЧЕНИЯ ДЛЯ ТЕЛЕМЕДИЦИНСКОЙ ИНФОРМАЦИОННОЙ СИСТЕМЫ

\tsp{1,2}А.С. Сейтенов\envelope,
\tsp{1}Т.К. Жукабаева
\end{header}
...
\begin{header}
ТЕЛЕМЕДИЦИНАЛЫҚ АҚПАРАТТЫҚ ЖҮЙЕ ҮШІН МАШИНАЛЫҚ ОҚЫТУҒА НЕГІЗДЕЛГЕН ҮДЕРІСТЕРДІ АВТОМАТТАНДЫРУ
...
машиналық оқыту, денсаулық сақ\-тау ақпараттық жүйесі, болжамдық
...
B. \emph{Identifying} Research Gaps
...
\fig[0.7\textwidth]{i/image7}[Fig.1 - Graphical representation of source]
...
\tcap{Table 1 - Description for TIS approaches}
\begin{longtblr}[
  label = none,
  entry = none,
]{
  width = \linewidth,
  colspec = {Q[192]Q[58]Q[256]Q[433]},
  cells = {c},
  hlines,
  vlines,
}
\textbf{Study}       & \textbf{Year} & \textbf{Method Used}          & \textbf{Advantages}                               \\
Häyrinen et al.[24]  & 2008          & Data format standardisation   & Data format standardisation                       \\
DesRoches et al.[23] & 2008          & TIS implementation            & Reduced patient wait times                        \\
Epizitone et al.[21] & 2023          & AI and blockchain integration & Enhanced security, automated decision-making      \\
Liu et al. [5]       & 2020          & Blockchain for security       & Strong encryption and distributed access control  \\
Ahmad et al. [7]     & 2021          & Blockchain in telehealth      & Tamper-proof logging and improved patient privacy 
\end{longtblr}
...
\fig[0.7\textwidth]{i/image8}[Fig.2 - Progression of research publications on TIS implementation]
...
\fig[0.5\textwidth]{i/image9}[Fig.3 - Key challenges in TIS implementation]
...
Жукабаева Т.К. - PhD, профессор, Евразийский национальный университет
им. Л.Н.Гумилёва, Астана, Казахстан, e-mail:
