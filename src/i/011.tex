...
\begin{header}
\swa{}{REVIEW OF REAL-WORLD APPLICATIONS OF NLP-BASED KEYWORD IDENTIFICATION}
...
\corrauthor{Corresponding author: d.ganiuly@astanait.edu.kz}
\end{affil}
...
keywords, algorithms, techniques, id\-entification.

\begin{header}
NLP НЕГІЗІНДЕГІ КІЛТІ СӨЗДЕРДІ АНЫҚТАУ НЕГІЗГІ СӨЗДЕРДІ ҚОЛДАНУЛАРДЫ ШОЛУ
...
\begin{header}
ОБЗОР РЕАЛЬНЫХ ПРИМЕНЕНИЙ ИДЕНТИФИКАЦИИ КЛЮЧЕВЫХ СЛОВ НА ОСНОВЕ NLP
...
\fig[0.6\textwidth]{i2/image49}[Fig.1 - The order of article selection steps]
...
\(Fp\) = Frequency of phrase \emph{p} -- how many
...
\(S\left( w_{i} \right)\) - the score importance of word \(w_{i}\);

\(d\) - The damping factor, typically set to 0.85;

\(N\left( w_{i} \right)\) - The set of neighboring words for word \(w_{i}\)
;
\(C\left( w_{j} \right)\) - The number of outgoing edges from word \(w_{j.}\)
...
\tcap{Table 1 - Overview of Keyword Extraction Approaches}
\fig{i2/image50}
...
\fig[0.4\textwidth]{i2/image51}[Fig.2 - Classification of keyword extraction algorithms]
...
\tcap{Table 2 - Qualitative Performance of Methods on Educational Content}
\fig[0.7\textwidth]{i2/image52}
...
\fig[0.6\textwidth]{i2/image53}[Fig.3 - Keyword Redundancy Across Extraction Algorithms]
\fig[0.6\textwidth]{i2/image54}[Fig.4 - Keyword Diversity Across Extraction Algorithms]
...
The findings also provide practical recommenda\-tions for selecting
...
-Vol.11.-P.144778-144798. DOI 10.1109/ACCESS.2023.3344032.
...
-P.113-121. \href{https://doi.org/10.1016/j.neucom.2019.11.083}{DOI
...
71805-71813. DOI 10.1109/ACCESS.2022.3188861
...
-2020. -Vol.8.-P.117528-117538. DOI 10.1109/ACCESS.2020.3004628.
...
-Vol.12(9): 1349. DOI 10.3390/math12091349.
...
(AKBC). -2018. -Vol. \href{https://arxiv.org/abs/1801.04470}{arXiv:1801.04470}. DOI
10.48550/arXiv.1801.04470.
...
Ganiuly D. - Master of Technical Sciences, Astana IT University,
Astana, Kazakhstan, e-mail: d.ganiuly@astanait.edu.kz;

Kaibassova D. - PhD., Ass. Professor, Astana IT University, Astana,
Kazakhstan, e-mail: d.kaibasova@astanait.edu.kz.

\hspace{1em}\emph{{\bfseries Информация об авторах}}

Ганиулы Д. - магистр технических наук, Astana IT University, Астана,
Казахстан, e-mail: d.ganiuly@astanait.edu.kz;

Кайбасова Д. - доктор PhD, Асс. профессор, Astana IT University,
Астана, Казахстан, e-mail: d.kaibasova@astanait.edu.kz.
\end{info}
