...
{\bfseries Модуль категоризации товаров для маркетплейса: анализ алгоритмов
и выбор оптимального решения}

{\bfseries Н.С.
Глазырина}{\bfseries \envelope ,
Р.Р.
Бирназаров}{\bfseries ,
Ж.С.
Есенгалиева}

\emph{Евразийский национальный университет имени Л.Н. Гумилева, Астана,
Казахстан}
...
{\bfseries маркетплейс ҮШІН ӨНІМДердІ САНАТТАУ МОДУЛі: АЛГОРИТМДЕРДІ ТАЛДАУ
ЖӘНЕ ОҢТАйЛЫ ШЕШІМДІ ТАҢДАУ}

{\bfseries Н.С. Глазырина\envelope , Р.Р. Бирназаров, Ж.С.
Есенгалиева}
...
{\bfseries PRODUCT CATEGORIZATION MODULE FOR MARKETPLACE PLATFORMS:
ALGORITHM ANALYSIS AND OPTIMAL SOLUTION SELECTION}

{\bfseries N.S. Glazyrina\envelope , R.R. Birnazarov, Zh.S.
Yessengaliyeva}
...
natural language processing, stemming, TF-IDF, e-commerce.
...
{\bfseries Рис.1 - Обобщенный конвейер (pipeline) модуля категоризации
товаров}

\emph{Источник: разработано автором}
...
{\bfseries Таблица 1 - Фрагмент набора данных}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1926}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3734}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1926}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2414}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Идентификатор товара}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Наименование товара}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Идентификатор категории}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Наименование категории}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% 31433218 & Тормозные колодки YAMAHA OS443/для квадроцикла Yamaha & 4066
%% & Колодки для квадроциклов \\
%% 32115388 & Щетка для чистки цепи & 4023 & Другие автозапчасти для
%% мотоциклов \\
%% 13534798 & Композитная цепь противоскольжения Easy Grip EVO 10, 2 шт. &
%% 3629 & Антипробуксовочные приспособления \\
%% \end{longtable}
...
{\bfseries Таблица 2 - Фрагмент набора данных с полем
preprocessed\_item\_title}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2116}}
...
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1822}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1963}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Идентификатор товара}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% {\bfseries Наименование категории}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Наименование товара после предобработки}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% 31433218 & Тормозные колодки YAMAHA OS443/для квадроцикла Yamaha & 4066
%% & Колодки для квадроциклов & тормозн колодк yamaha квадроцикл yamaha \\
%% 32115388 & Щетка для чистки цепи & 4023 & Другие автозапчасти для
%% мотоциклов & щетк чистк цеп \\
%% 13534798 & Композитная цепь противоскольжения Easy Grip EVO 10, 2 шт. &
%% 3629 & Антипробуксовочные приспособления & композитн цеп противоскольжен
%% easy grip evo шт \\
%% \end{longtable}
...
Мультиномиальный наивный Байес (MultinomialNB).~Использован с
...
{\bfseries Таблица 3 - Архитектура RNN}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5766}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2629}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.1604}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Слой (Тип)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Форма выхода}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Параметры}
%% \end{minipage} \\
%% \midrule\noalign{}
...
{\bfseries Таблица 4 - Архитектура CNN}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.5961}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2578}}
...
{\bfseries Таблица 5 ­- Архитектура трансформера}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3178}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1825}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1668}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3330}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Слой (Тип)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% embedding (Embedding) & (None, None, 128) & 2,570,112 &
%% input\_layer{[}0{]}{[}0{]} \\
%% multi\_head\_attention (MultiHeadAttention) & (None, None, 128) & 66,048
%% & embedding{[}0{]}{[}0{]}, embedding{[}0{]}{[}0{]} \\
%% add (Add) & (None, None, 128) & 0 & embedding{[}0{]}{[}0{]},
%% multi\_head\_attention{[}0{]}{[}0{]} \\
%% layer\_normalization (LayerNormalization) & (None, None, 128) & 256 &
%% add{[}0{]}{[}0{]} \\
%% dropout\_1 (Dropout) & (None, None, 128) & 0 &
%% layer\_normalization{[}0{]}{[}0{]} \\
%% sequential (Sequential) & (None, None, 128) & 16,576 &
%% dropout\_1{[}0{]}{[}0{]} \\
%% add\_1 (Add) & (None, None, 128) & 0 & dropout\_1{[}0{]}{[}0{]},
%% sequential{[}0{]}{[}0{]} \\
%% layer\_normalization\_1 (LayerNormalization) & (None, None, 128) & 256 &
%% add\_1{[}0{]}{[}0{]} \\
%% multi\_head\_attention\_1 (MultiHeadAttention) & (None, None, 128) &
%% 66,048 & layer\_normalization\_1{[}0{]}{[}0{]},
%% layer\_normalization\_1{[}0{]}{[}0{]} \\
%% add\_2 (Add) & (None, None, 128) & 0 &
%% layer\_normalization\_1{[}0{]}{[}0{]},
%% multi\_head\_attention\_1{[}0{]}{[}0{]} \\
%% layer\_normalization\_2 (LayerNormalization) & (None, None, 128) & 256 &
%% add\_2{[}0{]}{[}0{]} \\
%% dropout\_4 (Dropout) & (None, None, 128) & 0 &
%% layer\_normalization\_2{[}0{]}{[}0{]} \\
%% sequential\_1 (Sequential) & (None, None, 128) & 16,576 &
%% dropout\_4{[}0{]}{[}0{]} \\
%% add\_3 (Add) & (None, None, 128) & 0 & dropout\_4{[}0{]}{[}0{]},
%% sequential\_1{[}0{]}{[}0{]} \\
%% layer\_normalization\_3 (LayerNormalization) & (None, None, 128) & 256 &
%% add\_3{[}0{]}{[}0{]} \\
%% global\_average\_pooling1d (GlobalAveragePooling1D) & (None, 128) & 0 &
%% layer\_normalization\_3{[}0{]}{[}0{]} \\
%% dense\_4 (Dense) & (None, 62) & 7,998 &
%% global\_average\_pooling1d{[}0{]}{[}0{]} \\
%% \end{longtable}
...
{\bfseries Таблица 6 - Значения метрик классификационных моделей}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2832}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1451}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1487}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1674}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1193}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1363}}@{}}
%% \toprule\noalign{}
...
%% {\bfseries Время, мс}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Общая точность}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Точность предсказания}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries ~Полнота}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries F1-мера}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries Мультиномиальный наивный Байес} & 0,76 & 0,820 & 0,858 & 0,820 &
%% 0,787 \\
%% {\bfseries Логистическая регрессия} & 3,819 & 0,905 & 0,912 & 0,905 &
%% 0,895 \\
%% {\bfseries Метод опорных векторов} & 3219 & 0,942 & 0,944 & 0,942 &
%% 0,937 \\
%% {\bfseries Дерево решений} & 1,921 & 0,916 & 0,925 & 0,916 & 0,911 \\
%% {\bfseries Случайный лес} & 74,9 & 0,942 & 0,948 & 0,942 & 0,936 \\
%% {\bfseries Рекуррентная нейронная сеть} & 35,38 & 0,916 & 0,923 & 0,916 &
%% 0,912 \\
%% {\bfseries Сверточная нейронная сеть} & 40,43 & 0,904 & 0,915 & 0,904 &
%% 0,899 \\
%% {\bfseries Трансформер} & 101,08 & 0,909 & 0,915 & 0,909 & 0,904 \\
%% \end{longtable}
...
{\bfseries Таблица 7 - Значения метрик ансамбля классификационных моделей}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1931}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1600}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1598}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1674}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1600}}
%%   >{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.1598}}@{}}
%% \toprule\noalign{}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% {\bfseries Ансамбль} & 75,244 & 0,943 & 0,949 & 0,943 & 0,937 \\
%% \end{longtable}
...
{\bfseries Рис.2 - Матрица ошибок модели Random Forest}
...
arXiv:1908.08984. -2019.\\
DOI 10.48550/arXiv.1908.08984.
