...
\begin{header}
\swa{И. Масырова, С.К. Джолдасбаев, А.Р. Гизатуллина, М.Ж. Жанадилов, О.К.~Джолдасбаев, А.А.~Орманбекова, С.Т. Мамбетов}{ГИБРИДНАЯ МОДЕЛЬ МАССОВОГО ОБСЛУЖИВАНИЯ С ДИНАМИЧЕСКИМИ ПАРАМЕТРАМИ ДЛЯ АВТОМАТИЗИРОВАННОЙ СИСТЕМЫ}

\tsp{1}И. Масырова,
\tsp{1}С.К. Джолдасбаев,
\tsp{1}А.Р. Гизатуллина,
\tsp{1}М.Ж. Жанадилов,
\tsp{2}О.К.~Джолдасбаев,
\tsp{3}А.А.~Орманбекова,
\tsp{3,4}С.Т. Мамбетов\envelope
\end{header}

\begin{affil}
\tsp{1}Международный университет информационных технологий, Алматы, Казахстан,

\tsp{2}Филиал академии государственного управления при Президенте РК по Алматинский области, Конаев, Казахстан,

\tsp{3}Алматинский технологический университет, Алматы, Казахстан,

\tsp{4}Университет «Туран», Алматы, Казахстан
...
\begin{header}
АВТОМАТТАНДЫРЫЛҒАН ЖҮЙЕ ҮШІН ДИНАМИКАЛЫҚ ПАРАМЕТРЛЕРІ БАР ГИБРИДТІ КЕЗЕК ҮЛГІСІ
...
\begin{affil}
\tsp{1}Халықаралық ақпараттық технологиялар университеті, Алматы, Қазақстан,

\tsp{2}ҚР Президентінің жанындағы мемлекеттік басқару академиясының Алматы облысы бойынша филиалы, Қонаев, Қазақстан,

\tsp{3}Алматы технологиялық университеті, Алматы, Қазақстан,

\tsp{4}«Тұран» университеті, Алматы, Қазақстан
...
\begin{header}
A HYBRID QUEUEING MODEL WITH DYNAMIC PARAMETERS FOR AN AUTOMATED SYSTEM

\tsp{1}I. Massyrova,
\tsp{1}S.K. Joldasbayev,
\tsp{1}А.R. Gizatullina,
\tsp{1}М.Zh. Zhanadilov,
\tsp{2}О.К. Joldasbayev,
\tsp{3}А.А.~Ormanbekova,
\tsp{3,4}S.Т. Mambetov\envelope
\end{header}

\begin{affil}
\tsp{1}International IT University, Almaty, Kazakhstan,

\tsp{2}Branch of the Academy of Public Administration under the president of the Republic of Kazakhstan in Almaty region, Konayev, Kazakhstan,

\tsp{3}Almaty Technological University, Almaty, Kazakhstan,

\tsp{4}Turan University, Almaty, Kazakhstan,
...
propo\-ses a hybrid queuing model with dynamic parameters, designed for
...
mechanisms, allowing for considerat\-ion of time fluctuations, priorities,
...
\fig{i/image50}[Рис.1 - Сравнение моделей с учетом улучшений]

\fig{i/image51}[Рис.2 - Влияние количества студентов на отказы]

\fig{i/image52}[Рис.3 - Влияние числа студентов на среднее время нахождения
запроса в системе]

\fig{i/image53}[Рис.4 - Зависимость плотности вероятности от времени пребывания
запроса в системе]
...
grammar checking. GPT-4. Модель использовалась исключительно для
помощи в редактировании текста и структурировании научного
изложения .- Дата обращения: 06.10.2025.
\end{refs}
