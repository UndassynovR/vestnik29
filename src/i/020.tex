...
{\bfseries МОДЕЛИРОВАНИЕ СЦЕНАРИЕВ НАРУШЕНИЙ ЦЕЛОСТНОСТИ ДАННЫХ В
ИНТЕЛЛЕКТУАЛЬНЫХ СИСТЕМАХ КОММУНИКАЦИОННОГО ВЗАИМОДЕЙСТВИЯ}

\tsp{1} {\bfseries Л.О.
Жумабаева},
\tsp{2}{\bfseries Mohamed
Othman},
\tsp{1}{\bfseries М.А.Орынбасар}{\bfseries \envelope ,}
\tsp{1}{\bfseries Б.А.
Жұмажан},

{\bfseries М.Е.}
\tsp{1}{\bfseries Ақбердиева}

\emph{\tsp{1}Каспийский университет технологий и инжиниринга
имени Ш. Есенова, г. Актау, Казахстан}

\emph{\tsp{2}Universiti Putra Malaysia, Malaysia}
...
{\bfseries ИНТЕЛЛЕКТУАЛДЫ КОММУНИКАЦИЯЛЫҚ ӨЗАРА ӘРЕКЕТТЕСУ ЖҮЙЕЛЕРІНДЕГІ
ДЕРЕКТЕР ТҰТАСТЫҒЫНЫҢ БҰЗЫЛУ СЦЕНАРИЙЛЕРІН МОДЕЛЬДЕУ}

{\bfseries \tsp{1}Л.О. Жумабаева, \tsp{2}Mohamed
Othman, \tsp{1}М.А.Орынбасар, \tsp{1}Б.А.
Жұмажан\envelope , \tsp{1}М.Е. Ақбердиева}
...
{\bfseries MODELING SCENARIOS OF DATA INTEGRITY VIOLATIONS IN INTELLIGENT
COMMUNICATIVE INTERACTION SYSTEMS}

{\bfseries ¹L.O. Zhumabayeva, \tsp{2}Mohamed Othman,
\tsp{1}M.A. Orynbassar, \tsp{1}B.A. Zhumazhan,}

{\bfseries \tsp{1}M.E. Akberdiyeva}

\emph{\tsp{1}Sh. Yessenov Caspian University of Technology
and Engineering, Aktau, Kazakhstan,}

\emph{\tsp{2}Universiti Putra Malaysia, Malaysia,}

e-mail:
\href{mailto:1.orynbassar@yu.edu.kz}{maksym1,orynbassar@yu.edu.kz}
...
{\bfseries Fig.1 - Architecture of the simulation model of an intelligent
social system}
...
{\bfseries Fig.2 - Dynamics of the data integrity coefficient (Integrity
Rate) during modeling}
...
University of Technology and Engineering, Aktau, Kazakhstan\emph{,}
...
Orynbassar M.A. - Assistant of the Department of Computer Technologies,
Sh. Yessenov Caspian University of Technology and Engineering, Aktau,
Kazakhstan\emph{,} e-mail: maksym1.orynbassar@yu.edu.kz;

Zhumazhan B.А. - Assistant of the Department of SMART Technologies, Sh.
Yessenov Caspian University of Technology and Engineering, Aktau,
Kazakhstan\emph{,} e-mail:
bekezhan1.zhumazhan@yu.edu.kz;

Akberdiyeva M.Ye.- Master's Student of the Department of Computer
Technologies, Aktau, Kazakhstan\emph{,} e-mail:
...
Орынбасар М.А. - ассистент кафедры «Компьютерных технологий», Каспийский
